            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              ...
              <Card className="md:col-span-2 lg:col-span-3 border-0 bg-card/50 backdrop-blur-sm shadow-lg">
                <CardHeader className="text-center pb-4">
                  <div className="h-16 w-16 rounded-full bg-gradient-to-br from-green-500/20 to-green-600/20 flex items-center justify-center mx-auto mb-4">
                ...
                <CardContent className="space-y-6">
                  <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div className="flex items-start space-x-3 p-4 rounded-lg bg-gradient-to-r from-background/80 to-background/40">
                      <div className="h-8 w-8 rounded-lg bg-yellow-100 dark:bg-yellow-900/20 flex items-center justify-center flex-shrink-0">
                  ...
                  <div className="flex items-center justify-center space-x-4 pt-4">
                    ...
                    <Button disabled className="bg-gradient-to-r from-green-500 to-green-600 text-white opacity-50">
